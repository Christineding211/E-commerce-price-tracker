...
#### build docker image
    ...
    # add export_product_price_timeline_to_gcs/ oad_product_price_timeline_to_bigquery
    docker build -f with.env.Dockerfile_Airflow -t christine0211/e-commerce-airflow:0.0.14 .
    # Add fct daily prices BigQuery export pipeline
    docker build -f with.env.Dockerfile_Airflow -t christine0211/e-commerce-airflow:0.0.15 .
    docker build -f with.env.Dockerfile_Airflow -t christine0211/e-commerce-airflow:0.0.16 .
    # deal with worker and airflow mysql connection
    docker build -f with.env.Dockerfile_Airflow -t christine0211/e-commerce-airflow:0.0.17 .
    # fix momo empty price parsing
    docker build -f with.env.Dockerfile_Airflow -t christine0211/e-commerce-airflow:0.0.18 .
...
#### push docker image
    ...
    docker push christine0211/e-commerce-airflow:0.0.14
    docker push christine0211/e-commerce-airflow:0.0.15
    docker push christine0211/e-commerce-airflow:0.0.16
    docker push christine0211/e-commerce-airflow:0.0.17
    docker push christine0211/e-commerce-airflow:0.0.18
...
#### deploy airflow stack
    ...
    DOCKER_IMAGE_VERSION=0.0.14 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
    DOCKER_IMAGE_VERSION=0.0.14 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
    DOCKER_IMAGE_VERSION=0.0.15 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
    DOCKER_IMAGE_VERSION=0.0.16 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
    DOCKER_IMAGE_VERSION=0.0.17 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
    DOCKER_IMAGE_VERSION=0.0.18 docker stack deploy --with-registry-auth -c docker-compose-airflow.yml airflow
