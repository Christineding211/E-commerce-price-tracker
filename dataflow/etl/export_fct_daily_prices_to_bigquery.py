...
def create_fct_daily_prices_cloud_tasks():
    ...
    load_to_bigquery_task = GCSToBigQueryOperator(
        task_id="load_fct_daily_prices_to_bigquery",
        bucket=bucket_name,
